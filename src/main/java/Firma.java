...
class Firma{
	...
	try(BufferedReader br = new BufferedReader(new FileReader(new File("credentials.txt")))){
	    credentials = br.lines().collect(Collectors.toList());
	    System.out.println(credentials);
	}catch(FileNotFoundException fnfe){
	    System.out.println("********************************************************");
	    System.out.println("Datei credentials.txt m. Zugangsdaten für mariadb fehlt!");
